...
func (s *Service) Handle(ctx context.Context, req Request) (*Response, error) {
	...
	text, tokens, err := s.llm.Complete(ctx, shared.CompletionRequest{Model: "openai/gpt-4o-mini", SystemPrompt: prompt, Messages: messages, Temperature: 0.3, MaxTokens: 500})
	if err != nil {
